...
class _SplashScreenState extends State<SplashScreen>
  ...
  // Dog runs left → right across screen, looping
  ...
  void initState() {
    ...
    _dogX = Tween<double>(begin: -0.15, end: 1.1).animate(
      CurvedAnimation(parent: _runController, curve: Curves.linear),
    );
              ...
              child: Row(
                ...
                children: [
                  ...
                  AnimatedBuilder(
                    ...
                    builder: (context, _) {
                      final secondsLeft =
                          ((1.0 - _timerController.value) * 10).ceil();
